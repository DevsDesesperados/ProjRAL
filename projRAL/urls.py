...
urlpatterns = [
                ...
                path("menu/cadastrotecnicolavra",views.cadastrotec_lavra),
                path("menu/dadosbasicosminas",views.dados_minas),
                path("menu/demaisdadosminas",views.demaisdados_minas),
                path("menu/lavraproducaobruta",views.lavra_producaobruta),
                path("menu/projproducaobruta",views.proj_producaobruta),
